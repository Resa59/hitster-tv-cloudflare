...
async function handleApi(request, env, url) {
  ...
  if (url.pathname === "/api/contract" && request.method === "GET") {
    return json({
      ...
      pairingQr: "https://{host}/pair#v=1&code={code}&pair={pairToken}",
      pairingQrPageClaimsSession: false,
      endpoints: {
